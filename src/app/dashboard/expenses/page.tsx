    ...
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Average per Month</p>
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {formatPrice(
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">Expenses</h2>
        </div>
                ...
                <tr key={expense.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-900 dark:text-white capitalize">{expense.category}</span>
                    </div>
                  </td>
